<template>
  <div class="dh-scroller-content">
    ...
    <div @click="scrollToTop" class="dh-scrollTotop" :class="{'dh-isshow': showScrollTop}">
      <svg t="1500601594585" class="icon" viewBox="0 0 1024 1024" width="100%" height="100%"><path d="M512 512m-512 0a512 512 0 1 0 1024 0 512 512 0 1 0-1024 0Z" fill="#00a6ff" p-id="2481"></path><path d="M514.844444 429.82716a31.604938 31.604938 0 0 0-25.852839 9.039013l-252.207407 252.207407a31.604938 31.604938 0 0 0 0 44.689383 31.604938 31.604938 0 0 0 44.689382 0l233.370864-233.118025 233.307655 233.307655a31.604938 31.604938 0 0 0 44.689382-44.689383l-252.207407-252.207408A31.604938 31.604938 0 0 0 514.844444 429.82716zM284.444444 322.37037h461.432099a31.604938 31.604938 0 0 1 0 63.209877H284.444444a31.604938 31.604938 0 0 1-31.604938-31.604938 31.604938 31.604938 0 0 1 31.604938-31.604939z" fill="#FFFFFF"></path></svg>
    </div>
  </div>
</template>
